...
const Container = /*#__PURE__*/_react.default.memo( /*#__PURE__*/_react.default.forwardRef(({
  ...
  const [tabBarHeight, setTabBarHeight] = _react.default.useState(initialTabBarHeight);

  const [headerHeight, setHeaderHeight] = _react.default.useState(!HeaderComponent ? 0 : initialHeaderHeight);

  const contentInset = _react.default.useMemo(() => _helpers.IS_IOS ? (headerHeight || 0) + (tabBarHeight || 0) : 0, [headerHeight, tabBarHeight]);
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => {
    ...
    if (trigger) {
      ...
      tabNamesArray.forEach(name => {
        ...
        (0, _helpers.scrollToImpl)(refMap[name], 0, scrollY.value[index.value] - contentInset, false);
      });
  ...
  return /*#__PURE__*/_react.default.createElement(_Context.Context.Provider, {
    ...
    pointerEvents: "box-none"
  }, HeaderComponent && HeaderComponent), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: [styles.container, styles.tabBarContainer],
    onLayout: getTabBarHeight,
    pointerEvents: "box-none"
  }, TabBarComponent && /*#__PURE__*/_react.default.createElement(TabBarComponent, {
